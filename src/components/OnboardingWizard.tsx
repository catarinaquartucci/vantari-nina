    ...
    const initializeAndLoad = async () => {
      ...
      try {
        ...
        if (data) {
          ...
          setEvolutionInstance((data as any).evolution_instance || '');
    ...
    switch (stepIndex) {
      ...
      case 1: // Evolution API
        console.log('[OnboardingWizard] Step 1 (Evolution API) values:', { 
          ...
          evolutionInstance: evolutionInstance || 'EMPTY',
        });
        if (!evolutionApiUrl?.trim()) issues.push('URL da API está vazia');
        if (!evolutionInstance?.trim()) issues.push('Nome da instância está vazio');
        break;
      case 2: // Agent
  ...
  const saveSettings = useCallback(async () => {
    ...
    try {
      ...
      console.log('[OnboardingWizard] Step 4: Save result:', {
        ...
        evolution_api_url: (result.data as any).evolution_api_url ? '✓ SAVED' : '✗ NOT SAVED',
        evolution_instance: (result.data as any).evolution_instance ? '✓ SAVED' : '✗ NOT SAVED',
      ...
      if (verifyError) {
        ...
        console.log('[OnboardingWizard] ✓ Verification result:', {
          ...
          evolution_api_url: '(verified via env vars)',
      ...
      case 1:
        return (
          <StepWhatsApp
            ...
            onEvolutionInstanceChange={setEvolutionInstance}
